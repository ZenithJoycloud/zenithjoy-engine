...
- [ ] hooks/stop.sh 添加 cleanup_done 检测逻辑（在 .dev-mode 存在检查后）
- [ ] hooks/stop.sh PR 合并时输出 "下一步: 执行 Step 11 (Cleanup)" 并 exit 2
- [ ] skills/dev/scripts/cleanup.sh 在最后添加 "cleanup_done: true" 到 .dev-mode
- [ ] 单元测试覆盖新逻辑
